...
func test_empty_hand_and_bedrock() -> void:
	...
	_check(wood, null, BlockData.BreakCheck.CAN_BREAK)
	...
	assert_true(dirt.allows_bare_hands())
	assert_true(wood.allows_bare_hands())
	assert_false(stone.allows_bare_hands())
	assert_false(copper.allows_bare_hands())
...
func test_trees_require_axe() -> void:
	...
	assert_true(oak.can_fell_with(null))
	assert_true(birch.can_fell_with(null))
	assert_true(pine.can_fell_with(null))
	...
	_check(_block("res://resources/blocks/oak_wood.tres"), null, BlockData.BreakCheck.CAN_BREAK)
	_check(_block("res://resources/blocks/birch_wood.tres"), null, BlockData.BreakCheck.CAN_BREAK)
	_check(_block("res://resources/blocks/pine_wood.tres"), null, BlockData.BreakCheck.CAN_BREAK)
	_check(_block("res://resources/blocks/building/walls/wood_wall.tres"), null, BlockData.BreakCheck.WRONG_TOOL)
